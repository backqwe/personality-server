...
public class ApiConfHandle {
    ...
    /**
     * 生成增强配置集合
     * todo 接口增强执行（监听器部分 + 启动初始化部分1）
     * @param s
     * @return
     */
    public Map<String, Set<String>> makeApiEnhanceMap(String s) throws IOException {
    ...
    /**
     * 生成增强处理列表
     * todo 接口增强执行（启动初始化部分2）
     * @return
     */
    public List<ApiFaceEnhanceHandler> makeApiEnhanceHandlerList() {

        // todo 需要测试下是否正常 从springBean容器中获取实现ApiFaceEnhanceHandler的所有类
